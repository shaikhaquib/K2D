...
import com.abatechnology.kirana2door.activities.AboutUs;
import com.abatechnology.kirana2door.activities.ChangePassword;
import com.abatechnology.kirana2door.activities.LoginActivity;
import com.abatechnology.kirana2door.activities.ManageAddress;
import com.abatechnology.kirana2door.activities.PersonalInfo;
import com.abatechnology.kirana2door.activities.PrivacyPolicy;
import com.abatechnology.kirana2door.activities.UpdateContact;
...
public class Frg_Menu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mnaboutus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
