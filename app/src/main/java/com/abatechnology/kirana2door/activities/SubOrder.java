...
import com.abatechnology.kirana2door.adapters.SubOrderHistoryProductListItem;
import com.abatechnology.kirana2door.adapters.SubOrderList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new RecyclerView.Adapter() {
            ...
            public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
                ...
                myHolder.prodqty.setText("Qty - "+Integer.toString(qty)+" "+model.getCurrentProductUnit());
