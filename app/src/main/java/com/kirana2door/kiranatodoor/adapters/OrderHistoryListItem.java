...
public class OrderHistoryListItem{
	...
	@SerializedName("gst_ammount")
	private String gstAmmount;
	...
	@SerializedName("delivery_add2")
	private String deliveryAdd2;

	@SerializedName("delivery_add3")
	...
	public void setFinalAmmount(String finalAmmount){
		this.finalAmmount = finalAmmount;
	}

	public String getFinalAmmount(){
		return finalAmmount;
	}
	...
	public void setGstAmmount(String gstAmmount){
		this.gstAmmount = gstAmmount;
	}

	public String getGstAmmount(){
		return gstAmmount;
	}
	...
	@Override
 	public String toString(){
		return 
			...
			",logo_img = '" + logoImg + '\'' + 
			",latlang = '" + latlang + '\'' + 
			",gst_ammount = '" + gstAmmount + '\'' + 
			",payment_type = '" + paymentType + '\'' + 
			",openingtime = '" + openingtime + '\'' + 
			",delivery_add2 = '" + deliveryAdd2 + '\'' + 
			",delivery_add3 = '" + deliveryAdd3 + '\'' + 
